"use strict";
var precacheConfig = [
    ["/index.html", "7acb925d59c4c26fdecdc093a50b3308"],
    ["/static/css/main.5290e4c3.css", "80531f36ba4c8de202ebb06dda67f403"],
    ["/static/js/main.5cb83972.js", "e59284820a370751da88b84bd186feca"],
    ["/static/media/brand-icons.13db00b7.eot", "13db00b7a34fee4d819ab7f9838cc428"],
    ["/static/media/brand-icons.a046592b.woff", "a046592bac8f2fd96e994733faf3858c"],
    ["/static/media/brand-icons.a1a749e8.svg", "a1a749e89f578a49306ec2b055c073da"],
    ["/static/media/brand-icons.c5ebe0b3.ttf", "c5ebe0b32dc1b5cc449a76c4204d13bb"],
    ["/static/media/brand-icons.e8c322de.woff2", "e8c322de9658cbeb8a774b6624167c2c"],
    ...
    ["/static/media/outline-icons.701ae6ab.eot", "701ae6abd4719e9c2ada3535a497b341"],
    ["/static/media/outline-icons.82f60bd0.svg", "82f60bd0b94a1ed68b1e6e309ce2e8c3"],
    ["/static/media/outline-icons.ad97afd3.ttf", "ad97afd3337e8cda302d10ff5a4026b8"],
    ["/static/media/outline-icons.cd6c777f.woff2", "cd6c777f1945164224dee082abaea03a"],
  ...
  createCacheKey = function(e, t, a, n) {
    var c = new URL(e);
    return (n && c.pathname.match(n)) || (c.search += (c.search ? "&" : "") + encodeURIComponent(t) + "=" + encodeURIComponent(a)), c.toString();
  },
  ...
  self.addEventListener("fetch", function(t) {
    if ("GET" === t.request.method) {
      ...
      !e &&
        ...
        ((a = new URL(c, self.location).toString()), (e = urlsToCacheKeys.has(a))),
        e &&
          t.respondWith(
            caches
              .open(cacheName)
