...
export const checkContractType = address => dispatch => {
  const network = "rinkeby";
  axios
    .get(`${config.api_base_url}/identify`, { params: { address, network } })
    .then(response => {
...
export const getName = address => dispatch => {
  const network = "rinkeby";
  axios
    .get(`${config.api_base_url}/pollscan/name`, { params: { address, network } })
    .then(response => {
      if (response.data.message === constants.SUCCESS) {
        dispatch({
...
export const getStartTime = address => dispatch => {
  const network = "rinkeby";
  axios
    .get(`${config.api_base_url}/pollscan/starttime`, { params: { address, network } })
    .then(response => {
      if (response.data.message === constants.SUCCESS) {
        dispatch({
...
export const getEndTime = address => dispatch => {
  const network = "rinkeby";
  axios
    .get(`${config.api_base_url}/pollscan/endtime`, { params: { address, network } })
    .then(response => {
      if (response.data.message === constants.SUCCESS) {
        dispatch({
...
export const getVoterBaseDenominator = address => dispatch => {
  const network = "rinkeby";
  axios
    .get(`${config.api_base_url}/pollscan/totalvotes`, { params: { address, network } })
    .then(response => {
      if (response.data.message === constants.SUCCESS) {
        dispatch({
...
export const getPollType = address => dispatch => {
  const network = "rinkeby";
  axios
    .get(`${config.api_base_url}/pollscan/polltype`, { params: { address, network } })
    .then(response => {
      if (response.data.message === constants.SUCCESS) {
        dispatch({
...
export const getVoterBaseLogic = address => dispatch => {
  const network = "rinkeby";
  axios
...
export const getProposalsWithVotes = address => dispatch => {
  const network = "rinkeby";
  axios
...
export const getVoteTalliesWeighted = address => dispatch => {
  const network = "rinkeby";
  axios
    .get(`${config.api_base_url}/pollscan/votetallies`, { params: { address, network } })
    .then(response => {
      if (response.data.message === constants.SUCCESS) {
        dispatch({
